  ...
  return (
    <div className="page active">
      <div style={{ display: 'flex', gap: '10px', marginBottom: '18px', alignItems: 'center' }}>
        <select className="fi" style={{ width: '220px' }} defaultValue="Cấu trúc dữ liệu"><option>Cấu trúc dữ liệu</option><option>Lập trình Web</option></select>
        <select className="fi" style={{ width: '160px' }} defaultValue="CNTT-K22A"><option>CNTT-K22A</option><option>CNTT-K22B</option></select>

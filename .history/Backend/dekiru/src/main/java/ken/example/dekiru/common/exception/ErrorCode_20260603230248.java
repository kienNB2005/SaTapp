...
public enum ErrorCode {
    ...
    USER_NOT_EXISTED(1141, "Người dùng không tồn tại", HttpStatus.NOT_FOUND),
    PASSWORD_NOT_MATCH(1142, "Mật khẩu xác nhận không khớp", HttpStatus.BAD_REQUEST),
    PASSWORD_INVALID(1143, "Mật khẩu phải có ít nhất 6 ký tự", HttpStatus.BAD_REQUEST),
    WRONG_PASSWORD(1144, "Mật khẩu cũ không chính xác", HttpStatus.BAD_REQUEST);

        ...
        <svg width="100%" height={chartHeight + 60} viewBox={`0 0 ${chartWidth + 50} ${chartHeight + 60}`} style={{ minWidth: '100%', overflow: 'visible' }}>
          ...
          {[0, 25, 50, 75, 100].map((val) => (
            <g key={`y-${val}`}>
              ...
              <line x1="22" y1={topPadding + chartHeight - (val / 100) * chartHeight} x2={chartWidth + 30} y2={topPadding + chartHeight - (val / 100) * chartHeight} 
                    stroke="var(--bd)" strokeWidth="0.5" strokeDasharray="2,2" opacity="0.4" />
            </g>
          ))}

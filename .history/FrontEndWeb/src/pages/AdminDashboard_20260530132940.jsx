...
import { Users as IconUsers, User as IconUser, BookOpen as IconBook, QrCode as IconQr } from 'lucide-react';
    ...
    <div className="sg admin-stats">
      <div className="sc bl">
        <div className="sc-head">
          <div className="sc-ic"><IconUsers className="stat-icon" /></div>
      ...
      <div className="sc gr">
        <div className="sc-head">
          <div className="sc-ic"><IconUser className="stat-icon" /></div>
      ...
      <div className="sc am">
        <div className="sc-head">
          <div className="sc-ic"><IconBook className="stat-icon" /></div>
      ...
      <div className="sc pu">
        <div className="sc-head">
          <div className="sc-ic"><IconQr className="stat-icon" /></div>
